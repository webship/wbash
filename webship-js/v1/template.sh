...
grep -rl "127.0.0.1" ${local_project_path}/nightwatch.conf.js | xargs sed -i "s|127.0.0.1|${selenium_host}|g";

# Replace 4444 with the selenium port.
grep -rl "4444" ${local_project_path}/nightwatch.conf.js | xargs sed -i "s|4444|${selenium_port}|g";
